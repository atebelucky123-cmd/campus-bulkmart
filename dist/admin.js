...
const SITE_CONTENT_DEFAULTS = {
  ...
  aboutHeroSubtitle: "From a simple idea to LASU's most trusted campus delivery platform — here's how Campus Bulkmart was born.",
  aboutOriginParagraph1: "Every LASU student knows the struggle — you're mid-assignment, your data runs out, your toiletries are empty, and the market feels a world away. **Campus Bulkmart** was born from exactly that frustration.",
  ...
  aboutOriginParagraph3: "What started as a simple idea has grown into a full-service campus superstore serving students across all LASU hostels daily.",
  aboutMissionQuote: "Make campus life easier — one delivery at a time.",
  aboutMissionText: "Our mission is simple: eliminate the friction between LASU students and the essentials they need. We believe no student should lose study time to market runs or go without because the market is far."
};
